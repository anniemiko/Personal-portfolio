          ...
          <div className="card horizontal">
            ...
            <div className="card-stacked">
              <div className="card-content">
                <p className="section">A budding front end developer with a passion for simple design and clean code. I am a recent graduate of The Iron Yard's front end engineering program, where I quickly became proficient in the basics of front end development - HTML, CSS and Javascript, along with relevant libraries and frameworks such as jQuery, SASS, Backbone, Handlebars, Bootstrap, React, and Materialize.</p>
